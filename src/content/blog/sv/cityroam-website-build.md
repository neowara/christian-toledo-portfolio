---
title: 'Att bygga cityroam.casa-verde.casa: en marknadsföringssajt utan marknadsföringsbudget'
...
Cityroam, Android-appen och backenden jag skrivit om tidigare, behövde en plats att skicka folk till som inte tänker läsa källkod. Det är [cityroam.casa-verde.casa](https://cityroam.casa-verde.casa): en enda-sidas Astro-sajt, deployad till Cloudflare Workers, som finns för att göra ett jobb, visa hur appen faktiskt ser ut, tillräckligt bra för att en främling ska kunna avgöra på tio sekunder om den är något för dem.

<figure>
  <img src="/blog/cityroam-dashboard.jpg" alt="Cityroam-appens dashboard-skärm med live batteri, spänning och körläge" />
...
<figure>
  <img src="/blog/cityroam-verdicts.jpg" alt="Cityroam-skärm som visar 'görbart', 'i underkant' eller 'inte tillräckligt' per körläge" />
...
<figure>
  <img src="/blog/cityroam-widget.jpg" alt="Turbos hemskärmswidget som visar senaste åkturens distans och lägesfördelning" />
...
"Varför"-sektionen och about-rutnätet säger rakt ut vad Cityroam inte är: inte anknutet till Tynee, NAVEE eller Tuya, inget upplåst eller kringgått på hårdvaran, inga annonser eller analys-SDK:er, anslutningsnycklar som aldrig lämnar telefonen. Det är inte juridisk standardtext för sin egen skull, det är samma instinkt bakom att [helt undvika Tuyas SDK](/blog/cityroam-tuya-free) i appen själv: säg exakt vad som är sant och låt det vara säljargumentet, istället för en marknadsföringssajts vanliga vana att antyda mer än produkten faktiskt gör.

<figure>
  <img src="/blog/cityroam-route-planner.jpg" alt="Turbos ruttplanerare med en karta för att peka ut en destination" />
